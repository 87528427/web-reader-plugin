...
bookConfig.BackgroundSoundURL = "files/mobile-ext/wodeweilaibushimeng.mp3";
...
bookConfig.MidBgColor = "#155189";
bookConfig.searchFontColor = "#FFFDDD";
bookConfig.totalPageCount = 20;
bookConfig.largePageWidth = 1800;
bookConfig.largePageHeight = 2443;;
bookConfig.securityType = "1";
bookConfig.CreatedTime = "181114084243";
bookConfig.bookTitle = "电子书样本";
bookConfig.bookmarkCR = "bb0a6ea2d42efe4be953e7dfebffbf26841afb86";
...
var language = [{
	...
	frmHowToUse: "使用说明",
	lblHelpPage1: "在手机屏幕上向右或向左滑动手指前后翻页",
	lblHelpPage2: "双击或者用拉大手势可以放大，然后可滑动手指调整样本位置查看局部细节",
	lblHelpPage3: "点击一下屏幕可以唤出或隐藏画册最下部的“导航栏图标”，使用缩略图、前进后退、放大缩小、自动翻页、声音控制、产品目录等功能",
	lblHelpPage4: "在微信中查看时，手机设置“自动旋转”后，并且从微信设置通用里面“开启横屏模示”后可以双页查看。",
	lblHelpPage5: "点击手机屏幕左上角的“×”退出查看样本",
